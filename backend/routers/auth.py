...
@limiter.limit("3/minute")  # Максимум 3 регистрации в минуту
...
@limiter.limit("20/minute")  # Максимум 20 запросов к me в минуту
async def get_me(request: Request, current_user: dict = Depends(AuthService.get_current_user)):
    return User(
