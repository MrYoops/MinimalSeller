...
from backend.routers.warehouses_marketplace import get_marketplace_warehouses
...
async def get_marketplace_warehouses_by_integration(
    ...
    try:
        ...
        from backend.routers.warehouses_marketplace import fetch_ozon_warehouses, fetch_wb_warehouses, fetch_yandex_warehouses
