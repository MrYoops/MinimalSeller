...
# ============================================================================
# TAGS ENDPOINTS (Public - no auth required)
# ============================================================================
...
async def create_tag_public(tag_name: str):
    """Создать новый тег"""
...
async def delete_tag_public(tag_name: str):
...
async def bulk_assign_tags_public(request: BulkTagsRequest):
...
async def bulk_remove_tags_public(request: BulkTagsRequest):
...
try:
    from profit_analytics_routes import router as profit_analytics_router
    app.include_router(profit_analytics_router)
    logger.info("Profit analytics routes included")
except Exception as e:
...
try:
    from reports_parser_routes import router as reports_parser_router
    app.include_router(reports_parser_router)
    logger.info("Reports parser routes included")
except Exception as e:
